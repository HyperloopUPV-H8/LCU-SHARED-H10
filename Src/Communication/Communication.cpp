...
void SPI_DATA::start()
{
    ...
    data_refs_control_current = new SPIPacket<80, LDU_REF_ARR_TYPE, LDU_EXIT_ARR_TYPE>(
    ...
    data_refs_control_1dof = new SPIPacket<64, DIS_REF_ARR_TYPE, DIS_EXIT_ARR_TYPE>(
    ...
    receive_ref_current_order = new SPIStackOrder(RECV_REF_CURRENT_ID, *nonePacket, *data_refs_control_current);
    receive_ref_1dof_order = new SPIStackOrder(RECV_REF_1DOF_ID, *nonePacket, *data_refs_control_1dof);
